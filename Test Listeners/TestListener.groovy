...
class NewTestListener {
	...
	def beforeSuite(TestSuiteContext suite) {
		ExtentReportManager.startSuite(suite, "Extent Report", "RezzaIlham_CermatiTest")
	}
		
	@BeforeTestCase
	def sampleBeforeTestCase(TestCaseContext testCaseContext) {
		ExtentReportManager.startTestCase(testCaseContext)
	...
	def sampleAfterTestCase(TestCaseContext testCaseContext) {
		ExtentReportManager.endTestCase(testCaseContext)
		println testCaseContext.getTestCaseId()
